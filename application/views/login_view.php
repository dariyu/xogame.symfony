					...
					<div class="panel-body">
						<form class="form" role="form" method="post" action="<?php echo $signin_url;?>">
							<div class="form-group">
								<input type="text" class="form-control" name="login" placeholder="<?php echo $this->lang->line('login_login_placeholder');?>"/>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="password" placeholder="<?php echo $this->lang->line('login_password_placeholder');?>"/>
							</div>
