...
class FrontController extends \Symfony\Bundle\FrameworkBundle\Controller\Controller implements \Xo\GameBundle\Abstraction\IStateHandler {
	...
	private function FormJsonResponse($response = null)
	{
		...
		return $this->response->setContent(json_encode($obj));
	}
